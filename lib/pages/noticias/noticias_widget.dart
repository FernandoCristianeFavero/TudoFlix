          ...
          child: StreamBuilder<List<NoticiasRecord>>(
            stream: queryNoticiasRecord(
              queryBuilder: (noticiasRecord) =>
                  noticiasRecord.orderBy('data', descending: true),
            ),
            builder: (context, snapshot) {
              ...
              List<NoticiasRecord> columnNoticiasRecordList = snapshot.data!;
              return SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: List.generate(columnNoticiasRecordList.length,
                      (columnIndex) {
                    final columnNoticiasRecord =
                        columnNoticiasRecordList[columnIndex];
                    return Padding(
                      padding:
                            ...
                            children: [
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    valueOrDefault<String>(
                                      columnNoticiasRecord.img,
                                      'https://fj.com.br/wp-content/uploads/2022/05/Modelo-de-Politica-de-Privacidade.png',
                                    ),
                                    width:
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 10.0, 15.0),
                                child: Text(
                                  columnNoticiasRecord.descricao!,
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
